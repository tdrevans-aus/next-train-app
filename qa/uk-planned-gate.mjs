...
console.log(
  "uk-planned-gate: ok (remaining UK regions planned/501; uk-london-tfl + west-of-england + east-midlands + uk-west-midlands + greater-anglia + liverpool-city-region + rest-of-scotland + london-se-national-rail + southwest + greater-manchester + south-yorkshire + north-east + glasgow + edinburgh live; no city=uk; Perth green)"
);
