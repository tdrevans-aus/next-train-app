...
const LIVE_UK_REGION_IDS = new Set(["uk-london-tfl", "west-of-england", "east-midlands", "uk-west-midlands", "liverpool-city-region", "solent", "west-yorkshire", "thames-valley", "greater-anglia", "south-wales", "rest-of-wales", "rest-of-scotland", "london-se-national-rail", "southwest", "greater-manchester", "south-yorkshire"]);
...
console.log(
  "uk-planned-gate: ok (remaining UK regions planned/501; uk-london-tfl + west-of-england + east-midlands + uk-west-midlands + greater-anglia + liverpool-city-region + rest-of-scotland + london-se-national-rail + southwest + greater-manchester + south-yorkshire live; no city=uk; Perth green)"
);
