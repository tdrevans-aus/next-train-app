...
const LIVE_UK_REGION_IDS = new Set(["uk-london-tfl", "west-of-england", "liverpool-city-region"]);
...
console.log(
  "uk-planned-gate: ok (uk-west-midlands and remaining UK regions planned/501; uk-london-tfl + west-of-england + liverpool-city-region live; no city=uk; Perth green)"
);
