...
const LIVE_UK_REGION_IDS = new Set(["uk-london-tfl", "west-of-england", "east-midlands"]);
...
console.log(
  "uk-planned-gate: ok (uk-west-midlands, uk-ellesmere-port, and remaining UK regions planned/501; uk-london-tfl + west-of-england + east-midlands live; no city=uk; Perth green)"
);
