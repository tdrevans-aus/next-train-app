/**
 * CAPACITOR-D: hideNearbyPinLeaveSurfaces must stay defined through Near me
 * pin + leave-by teardown (render / exit Nearby / dismiss).
...
async function run() {
  ...
  if (
    ...
    console.log("PASS — hideNearbyPinLeaveSurfaces stays defined through pin + Near me exit");
  } else {
