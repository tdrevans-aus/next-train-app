# gold-coast — local calendar-only GTFS fixture (hand-authored)

No last-known-good real zip was available for gold-coast when this fixture was created
...
staleness-detection LOGIC in qa/gold-coast-dogfood-gate.mjs without a network fetch.
...
```bash
node scripts/extract-gtfs-calendar-fixture.mjs gold-coast <path-to-real-zip>
```
