# gold-coast — local calendar-only GTFS fixture
...
**Source zip:** C:\Users\tdrev\AppData\Local\Temp\claude\C--Users-tdrev-Projects-next-train-app\1bbd2b25-bfba-41a6-8789-fda413e3cdec\scratchpad/gold-coast.zip
...
```bash
node scripts/extract-gtfs-calendar-fixture.mjs gold-coast <path-to-fresh-zip>
```
