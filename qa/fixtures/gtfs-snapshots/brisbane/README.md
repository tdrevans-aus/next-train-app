# brisbane — local calendar-only GTFS fixture (hand-authored)

No last-known-good real zip was available for brisbane when this fixture was created
...
staleness-detection LOGIC in qa/brisbane-dogfood-gate.mjs without a network fetch.
...
```bash
node scripts/extract-gtfs-calendar-fixture.mjs brisbane <path-to-real-zip>
```
