# canberra — local calendar-only GTFS fixture (hand-authored)

No last-known-good real zip was available for canberra when this fixture was created
...
staleness-detection LOGIC in qa/canberra-dogfood-gate.mjs without a network fetch.
...
```bash
node scripts/extract-gtfs-calendar-fixture.mjs canberra <path-to-real-zip>
```
