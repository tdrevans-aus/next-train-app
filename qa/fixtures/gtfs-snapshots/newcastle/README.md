# newcastle — local calendar-only GTFS fixture (hand-authored)

No last-known-good real zip was available for newcastle when this fixture was created
...
staleness-detection LOGIC in qa/newcastle-dogfood-gate.mjs without a network fetch.
...
```bash
node scripts/extract-gtfs-calendar-fixture.mjs newcastle <path-to-real-zip>
```
