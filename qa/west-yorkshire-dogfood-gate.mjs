...
assert(region?.railCount === 83, `west-yorkshire rail count must be 83 (1 station reassigned in from rest-of-england 15 Sep 2026, docs/jim-brief-rest-of-england-reassignment.md), got ${region?.railCount}`);
...
assert(allStations.length === 83, `combined catalog must have 83 stations (train only, 15 Sep 2026 rest-of-england reassignment), got ${allStations.length}`);
...
assert(dogfoodStations.length === 83, `dogfood stations must be the 83 catalog entries (15 Sep 2026 rest-of-england reassignment), got ${dogfoodStations.length}`);
