...
assert(entry?.displayName === "Aberdeen / Inverness / Dundee", "rest-of-scotland display name must be Aberdeen / Inverness / Dundee (docs/jim-brief-picker-countries-england-scotland-wales.md — the 'Scotland (…)' prefix is redundant inside the Scotland picker country)");
...
assert(getCity("perth")?.displayName !== "Aberdeen / Inverness / Dundee", "city id perth must remain Perth, Australia's own registry entry");
