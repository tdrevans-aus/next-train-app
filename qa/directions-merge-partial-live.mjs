...
assertSameDirections(elizabethStatic, ["Mandurah", "Perth"], "Elizabeth Quay static");
...
assertSameDirections(
  ...
  ["Mandurah", "Perth"],
  "partial live keeps both directions"
);
...
assertSameDirections(emptyLive.directions, ["Mandurah", "Perth"], "empty live uses static");
