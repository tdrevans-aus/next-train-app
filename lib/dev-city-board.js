...
import {
  fetchStationBoard as fetchMalmoBoard,
  listCatalogStations as listMalmoStations,
} from "./providers/malmo.js";
import {
  fetchStationBoard as fetchUppsalaBoard,
  listCatalogStations as listUppsalaStations,
...
const BOARD_FETCHERS = {
  ...
  malmo: {
    fetchBoard: fetchMalmoBoard,
    listStations: listMalmoStations,
  },
  uppsala: {
    fetchBoard: fetchUppsalaBoard,
    listStations: listUppsalaStations,
  },
  "uk-london-tfl": {
