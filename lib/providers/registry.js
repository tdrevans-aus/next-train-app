...
export const CITIES = [
  ...
  },
  {
    ...
    agency: "Västtrafik",
    integration:
      "Primary board: Västtrafik Planera Resa v4 (VASTTRAFIK_CLIENT_ID/VASTTRAFIK_CLIENT_SECRET, OAuth2 client-credentials) — live estimated times per stop area. Trafiklab GTFS Regional vt (TRAFIKLAB_API_KEY) supplies the static catalog/stop mapping and is the schedule-only fallback board; TripUpdates not published for vt, so the fallback stays schedule-only.",
    modes: ["tram", "train"],
    envKeys: ["TRAFIKLAB_API_KEY", "VASTTRAFIK_CLIENT_ID", "VASTTRAFIK_CLIENT_SECRET"],
    adapterReady: true,
    notes:
      "Tram 1–12 + city-map pendeltåg Kungsbacka/Alingsås/Ale. No metro, stombuss, båt, X-bus, or extra Västtågen. Hub Brunnsparken (8/12 miss it). Do not lock Centralstationen (Drottningtorget 15 Jun 2026). Västtågen hub Göteborg Central. DST. Testers live (flipped by Tim 29 Aug 2026); not a store listing. Live boards via Västtrafik Planera Resa v4 (docs/jim-brief-goteborg-vasttrafik-live.md); Trafiklab static is the timetable fallback. Quota unknown — 30s shared cache per stop area, conservative (see docs/goteborg-d1/jim-handoff.md).",
  },
  {
    id: "osaka",
    displayName: "Osaka",
  ...
  {
    id: "rest-of-wales",
    displayName: "Wales (North / Mid / West)",
    timeZone: "Europe/London",
    status: "live",
  ...
  {
    id: "rest-of-scotland",
    displayName: "Scotland (Aberdeen / Inverness / Dundee)",
    timeZone: "Europe/London",
    status: "live",
