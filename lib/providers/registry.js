...
export const CITIES = [
  ...
  },
  {
    ...
    adapterReady: true,
    notes:
      "22 Sep 2026: replaced the PTV Timetable API path (devid/PTV_API_KEY key never arrived) with the Open Data Portal's GTFS-RT feeds — live-verified across all 16 currently-running Metro line groups (Racecourse is special-events-only, not running at verification time) and all 13 V/Line route_ids at the shared stations. See docs/melbourne-d1/jim-handoff.md.",
  },
  {
    id: "brisbane",
