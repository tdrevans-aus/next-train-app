...
export const CITIES = [
  ...
  },
  {
    ...
    integration:
      "Trafiklab GTFS Regional skane (TRAFIKLAB_API_KEY static, TRAFIKLAB_API_KEY_RT realtime TripUpdates). Keys confirmed working live against real skane.zip/skane TripUpdates endpoints (2026-08-30); adapter degrades to schedule-only if RT key 403s.",
    modes: ["train"],
    envKeys: ["TRAFIKLAB_API_KEY", "TRAFIKLAB_API_KEY_RT"],
    adapterReady: true,
    notes:
      "Pågatågen regional rail only, 10 corridors, no passenger-facing line codes — chips are product + terminus (\"Pågatågen mot <far end>\"). Hub lock Malmö C, which Malmöringen (ring, line 11) calls twice per through-path with self-referential \"Malmö central\" headsign — special-cased chip (Oslo-Stortinget pattern). doNotGroup Öresundståg at Malmö C/Triangeln/Hyllie/Burlöv. No bus, no Öresundståg, no Krösatågen, no light rail (closed 1973). DST. D1 pack in docs/malmo-d1/. Flipped live by Mark, 30 Aug 2026.",
  },
  {
    id: "uppsala",
    displayName: "Uppsala",
