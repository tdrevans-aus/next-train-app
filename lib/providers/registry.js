...
export const CITIES = [
  ...
  },
  {
    ...
    adapterReady: true,
    notes:
      "TRAIN only. No bus/ferry/AirportLink/Te Huia. Hub Waitematā Station. CRL not passenger-open. DST. Do not flip live until Tim says testers get it.",
  },
  {
    id: "wellington",
  ...
  },
  {
    ...
    adapterReady: true,
    notes:
      "Tunnelbana 10/11/13/14/17/18/19 + Pendeltåg 40/41/43/48. No buses. Lock T-Centralen ≠ Stockholm City ≠ Stockholms central. Line 48 does not through-run Stockholm City. DST. Picker Coming Soon. Do not flip live. Trafiklab keys by env name only.",
  },
  {
    id: "canberra",
