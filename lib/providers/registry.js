...
export const CITIES = [
  ...
  },
  {
    ...
    adapterReady: true,
    notes:
      "Separate city from Auckland. TRAIN only (Kāpiti, Hutt Valley, Melling, Johnsonville, Wairarapa). No bus/ferry/cable car. D1 pack in docs/wellington-d1/. MEL live terminus Western Hutt while Melling Station closed. DST. Do not flip live.",
  },
  {
    id: "amsterdam",
  ...
  },
  {
    ...
    adapterReady: true,
    notes:
      "Tunnelbana 10/11/13/14/17/18/19 + Pendeltåg 40/41/43/48. No buses. Lock T-Centralen ≠ Stockholm City ≠ Stockholms central. Line 48 does not through-run Stockholm City. D1 pack in docs/stockholm-d1/. DST. Picker Coming Soon. Do not flip live. Trafiklab keys by env name only.",
  },
  {
    id: "goteborg",
    ...
    adapterReady: true,
    notes:
      "Tram 1–12 + city-map pendeltåg Kungsbacka/Alingsås/Ale. No metro, stombuss, båt, X-bus, or extra Västtågen. Hub Brunnsparken (8/12 miss it). Do not lock Centralstationen (Drottningtorget 15 Jun 2026). Västtågen hub Göteborg Central. DST. Picker Coming Soon. Do not flip live.",
  },
  {
    id: "osaka",
    displayName: "Osaka",
