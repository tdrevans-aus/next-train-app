...
export const CITIES = [
  ...
  },
  {
    ...
    adapterReady: true,
    notes:
      "GVB metro M50–M54 only. Not city=nl. Hub Centraal Station (not NS Amsterdam Centraal). DST. Testers live; not a store listing. OVapi GTFS-RT live (re-enabled 5 Sep 2026, PR #261); static fixture refreshed manually (see codebase-inventory 6.7).",
  },
  {
    id: "rotterdam",
    ...
    adapterReady: true,
    notes:
      "RET metro A–E only. Separate from amsterdam. Not city=nl or the-hague. Hub Beurs. DST. Testers live; not a store listing. OVapi GTFS-RT live (re-enabled 5 Sep 2026, PR #261); static fixture refreshed manually (see codebase-inventory 6.7).",
  },
  {
    id: "vancouver",
