 ...
 * unblocked.
 *
 * Denby Dale (DBD) and Walsden (WDN) are through-running-only boundary
 ...
 *
 * Adapter wired and verified live 5 Sep 2026 (docs/west-yorkshire-d1/
 * jim-handoff.md "Adapter wired" section) — lib/cities/west-yorkshire/
 * dogfood-next-train.js. Direction hub anchoring NOT wired for v1: all ten
 * catalogued stations' live chip sets were probed for an operator split on
 * "Leeds" or an obscure through-run terminus past Leeds; neither case
 * appeared, so no direction-hubs.json ships (see the dogfood module's file
 * header and jim-handoff.md for the chip-table evidence).
 */
