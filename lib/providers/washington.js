 ...
 * controller note 20 Sep 2026): MARC and VRE pass both walk-up tests at shared stations (Union
 * Station, Rockville, Silver Spring, New Carrollton, L'Enfant Plaza, Franconia-Springfield) but
 * come from feeds other than WMATA's API — ruled `out-product` by Tim, 20 Sep 2026 (a separate
 * agency feed/provider relationship is not justified before launch; revisit post-launch). They
 * are NOT wired in this adapter and must not be faked; this no longer holds the flip (see
