...
export class SupertramFeedUnconfirmedError extends FeedUnconfirmedError {
  constructor(stationIdOrName) {
    super({
      agency: "Sheffield Supertram",
      station: stationIdOrName,
      alternative: "National Rail stations in Sheffield still show live times.",
      detail:
      ...
      name: "SupertramFeedUnconfirmedError",
    });
  }
}
