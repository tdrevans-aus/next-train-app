 ...
 * docs/jim-brief-uk-crs-sweep-2.md) and Metrolink are two separate, non-co-located
 * stops (~0.5km apart) — never conflated in this catalog.
 */
...
export class MetrolinkFeedUnconfirmedError extends Error {
  constructor(stationIdOrName) {
    ...
    this.name = "MetrolinkFeedUnconfirmedError";
  }
}
