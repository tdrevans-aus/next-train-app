...
export class GlasgowSubwayFeedUnverifiedError extends FeedUnconfirmedError {
  constructor(stationIdOrName) {
    super({
      agency: "Glasgow Subway",
      station: stationIdOrName,
      alternative: "National Rail stations in Glasgow still show live times.",
      detail:
      ...
      name: "GlasgowSubwayFeedUnverifiedError",
    });
  }
}
