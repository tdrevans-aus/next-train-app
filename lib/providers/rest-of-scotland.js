 ...
 * (INV), Aberdeen (ABD), Dundee (DEE) into a hierarchy — each is
 ...
 * docs/jim-brief-uk-crs-corrections.md): three of this catalog's codes were
 * wrong (Dundee DDE->DEE, Kyle of Lochalsh KLS->KYL, Thurso THR->THS). All
 * stops carry crsVerified: true.
 */
