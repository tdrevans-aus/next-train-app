 ...
 * Fishguard Harbour's FGW/FGH ambiguity could not be resolved in that pass
 * (no DARWIN_LDB_TOKEN available to re-probe) — kept FGW and renamed the
 * entry to its actual station name, "Fishguard & Goodwick"; that entry
 * alone stays crsVerified: false. All other stops carry crsVerified: true.
 */
