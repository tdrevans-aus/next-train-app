...
export async function fetchStationBoard(stationIdOrName, options = {}) {
  ...
  // refresh — a genuinely separate second source degrading independently of the primary one
  // (unlike Boston, where subway and Commuter Rail share one MBTA V3 predictions call and so
  // fail together — lib/providers/boston.js).
