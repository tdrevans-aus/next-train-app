...
/** @typedef {"sydney"|"brisbane"|"adelaide"|"uk-london-tfl"|"amsterdam"|"rotterdam"|"vancouver"|"canberra"|"gold-coast"|"newcastle"|"auckland"|"stockholm"|"goteborg"|"wellington"|"malmo"|"uppsala"|"helsinki"|"oslo"|"uk-west-midlands"|"west-of-england"|"east-midlands"} MultiCityId */

/** @type {MultiCityId[]} */
export const MULTI_CITY_IDS = ["sydney", "brisbane", "adelaide", "uk-london-tfl", "amsterdam", "rotterdam", "vancouver", "canberra", "gold-coast", "newcastle", "auckland", "stockholm", "goteborg", "wellington", "malmo", "uppsala", "helsinki", "oslo", "uk-west-midlands", "west-of-england", "east-midlands", "liverpool-city-region"];
...
async function directionsFor(cityId, station) {
  ...
  if (cityId === "liverpool-city-region") {
    // National Rail: destination+operator derived live from Darwin, same approach as
    // West of England/East Midlands. Merseyrail: fetchMerseyrailStopBoard() throws
    // MerseyrailFeedUnconfirmedError unconditionally (no confirmed public real-time
    // feed) — surfaced here, not swallowed.
