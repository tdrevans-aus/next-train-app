...
function directionsFor(cityId, station) {
  ...
  if (cityId === "uk-london-tfl") {
    // For London, we don't have marketing labels yet, so return an empty list.
    // The user will see departures for all directions or we can implement line-based directions later.
    return { directions: [], source: "uk-london-tfl-default" };
  }
