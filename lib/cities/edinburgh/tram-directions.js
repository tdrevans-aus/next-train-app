...
export const DO_NOT_GROUP_PAIRS = [
  ...
  {
    a: { name: "Edinburgh Gateway", mode: "metro" },
    b: { name: "Edinburgh Gateway", mode: "train" },
    reason:
      "National Rail station added 13 Sep 2026 (UK station fill phase 1) shares a printed name with " +
      "the existing Trams stop — genuine interchange (tram-rail transfer station) but two distinct " +
      "catalog entries kept by mode, same pattern as Waverley/Haymarket.",
  },
];
