/**
 * Vancouver next-train payload for testers. TransLink GTFS-RT v3 + static SkyTrain fixture.
 */
import {
  VANCOUVER_TIME_ZONE,
  fetchStationBoard,
...
export function listVancouverDogfoodStations() {
...
export async function getVancouverDogfoodNextTrain({
  station,
  destination,
  destinationLabel,
  leaveBeforeMinutes,
...
export function getVancouverDogfoodDirections(station) {
  return {
    directions: marketingLabelsForStation(station),
    source: "vancouver-marketing-ends",
  };
}
