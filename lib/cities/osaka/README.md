...
- Direction: line + terminus (`Midosuji + Nakamozu`). Chips live in `marketing-directions.js`. Not inbound/outbound. Never “to City”.
- No adapter (`lib/providers/osaka.js`). No `dogfood-next-train.js`. No `public/city-catalogs/osaka.json`. No D6 sweep.
