/**
 * Canberra next-train payload for testers. Public CMO light-rail GTFS + GTFS-RT. No key.
 */
import {
  CANBERRA_TIME_ZONE,
  fetchStationBoard,
...
export function listCanberraDogfoodStations() {
...
export async function getCanberraDogfoodNextTrain({
  station,
  destination,
  destinationLabel,
  leaveBeforeMinutes,
...
export function getCanberraDogfoodDirections(station) {
  return {
    directions: marketingLabelsForStation(station),
    source: "canberra-marketing-ends",
  };
}
