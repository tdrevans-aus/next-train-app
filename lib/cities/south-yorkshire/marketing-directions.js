 ...
 * but also strips a trailing disambiguation suffix (e.g. "Swinton (South
 * Yorkshire)") so a catalog-disambiguated stop still matches its own line's
 * terminus string when the terminus is recorded without the suffix. Scoped
 * to this guard only — line/terminus membership checks elsewhere still use
 * the exact catalog name.
 */
