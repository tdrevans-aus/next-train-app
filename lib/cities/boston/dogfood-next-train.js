/**
 * Boston next-train payload. Subway/rapid transit AND Commuter Rail (at the five
 * board-eligible stations — South Station, North Station, Forest Hills, Braintree, JFK/UMass)
 * both come from live MBTA V3 predictions, no scheduled fallback — see
 * lib/providers/boston.js file header and docs/boston-d1/oracle-clash-report.md Board
 * eligibility section.
 */
import {
  BOSTON_TIMEZONE,
