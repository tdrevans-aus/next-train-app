/**
 * Wellington next-train payload for testers. Metlink GTFS-RT (METLINK_API_KEY). TRAIN only.
 */
import {
...
export function listWellingtonDogfoodStations() {
...
export async function getWellingtonDogfoodNextTrain({
  station,
  destination,
  destinationLabel,
  leaveBeforeMinutes,
...
export function getWellingtonDogfoodDirections(station) {
  return {
    directions: marketingLabelsForStation(station),
    source: "wellington-marketing-ends",
  };
}
