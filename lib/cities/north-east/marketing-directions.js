 ...
 * currently be built from it — it can't yet: the same bulk archive's
 * stop_times.txt is too large for the shared GTFS parser to ingest
 * (MetroGtfsTooLargeError, see lib/providers/north-east.js file header).
 * The station/route facts documented here were confirmed by parsing the
 * archive directly with a streaming reader during D2, independent of that
 * parser limitation.
