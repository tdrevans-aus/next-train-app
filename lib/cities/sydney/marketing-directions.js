...
export function loadPublishedNetwork() {
  const candidates = [
    "lib/cities/sydney/published-network.json",
    "qa/fixtures/sydney/published-network.json",
    "lib/cities/sydney/line-map.json",
  ];
  for (const relative of candidates) {
    ...
    return normalizePublishedNetwork(data);
  }
  throw new Error("Sydney published network fixture not found");
}
