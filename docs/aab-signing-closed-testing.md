...
**App ID:** `com.tdrevans.nexttrain` · current `versionName` **3.0.3** · `versionCode` **27** ([`android/app/build.gradle`](../android/app/build.gradle))
...
- [ ] Bump **`versionCode`** (integer, must increase every Play upload). Current is **27**; next upload → **28**, …
