...
**App ID:** `com.tdrevans.nexttrain` · current `versionName` **3.0.4** · `versionCode` **28** ([`android/app/build.gradle`](../android/app/build.gradle))
...
- [ ] Bump **`versionCode`** (integer, must increase every Play upload). Current is **28**; next upload → **29**, …
