...
| **U-15** | **Route vs Commute — product locks (FB-23)** | **Shipped Aug 2026 (FB-23 complete).** Locks: Route→Commute upgrade; all features free + ads; widget any saved route; commutes keep explicit Active from/until; two morning commutes switch at midpoint; copy **Target train**. See `docs/jim-brief-fb-23-route-vs-commute.md`. | 2026-08-16 · **shipped** |
