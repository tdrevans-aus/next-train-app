/**
 * Probe Canberra light rail board. Public CMO GTFS + RT — no API key.
 *
 *   node scripts/probe-canberra-board.mjs "Alinga Street"
...
if (!gate.ok) {
  console.error("Unexpected: canberra is not live");
  process.exit(1);
}
